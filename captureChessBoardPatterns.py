    ...
    while True:
        ...
        if isCalibrating:
            ...
            if retLeftCorner and retRightCorner:
                ...
                filename_left = './captures/capture_left' + str(today.year)+str(today.month)+str(today.day)+'-'+str(today.hour)+str(today.minute)+str(today.second)+".jpg"
                jsonfilename_left = './datas/data_left' + str(today.year)+str(today.month)+str(today.day)+'-'+str(today.hour)+str(today.minute)+str(today.second)+".json"
                ...
                filename_right = './captures/capture_right' + str(today.year)+str(today.month)+str(today.day)+'-'+str(today.hour)+str(today.minute)+str(today.second)+".jpg"
                jsonfilename_right = './datas/data_right' + str(today.year)+str(today.month)+str(today.day)+'-'+str(today.hour)+str(today.minute)+str(today.second)+".json"
